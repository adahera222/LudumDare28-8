...
class Reg {
	...
	static public var FADE:Fade = new Fade();
	
	static public var LAYER_FADE:Int = 0;
	static public var LAYER_HUD:Int = 1;
	static public var LAYER_FOREGROUND:Int = 2;
	static public var LAYER_PLAYER:Int = 3;
	static public var LAYER_PARTICLE:Int = 4;
	static public var LAYER_ENEMY:Int = 5;
	static public var LAYER_ITEM:Int = 6;
	static public var LAYER_MAP:Int = 7;
